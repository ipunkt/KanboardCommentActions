...
class CommentActionsSettingsController extends BaseController
{
    /**
    ...
    public function save()
    {
        ...
        $this->response->redirect($this->helper->url->to('CommentActionsSettingsController', 'index', array('plugin' => 'CommentActions')));
